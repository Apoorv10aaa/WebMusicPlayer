const conf = {
  ...
  appwriteElasticSearchFunctionId: String(
    import.meta.env.VITE_APPWRITE_ELASTIC_SEARCH_FUNCTION_ID
  ),
  appwriteMyUserId: String(import.meta.env.VITE_MY_USER_ID),
};
export default conf;
